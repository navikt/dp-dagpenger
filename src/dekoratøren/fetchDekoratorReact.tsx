...
export default async function fetchDekoratorReact(
  params?: DekoratorParams
): Promise<DekoratorReactComponents> {
  ...
  function createReactElements(element: Element) {
    return Object.values(element.children).map((element, key) =>
