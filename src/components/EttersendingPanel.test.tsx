...
jest.mock("next/config", () => () => ({
  publicRuntimeConfig: {
    NEXT_PUBLIC_SOKNADSDIALOG: "https://arbeid.dev.nav.no/dagpenger/dialog/soknad/",
  },
}));
...
test("lager url til ny søknadsdialog", async () => {
  ...
  expect(
    ...
    "href",
    "https://arbeid.dev.nav.no/dagpenger/dialog/soknad/3B41A7A9-4C5C-4BC5-A1EF-C2741988A973/ettersending"
  );
}, 3000);
